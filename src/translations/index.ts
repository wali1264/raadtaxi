...
const faTranslations = {
  ...
  pinScreenCreateTitle: "ایجاد رمز عبور",
  pinScreenCreateSubtitle: "از این رمز برای ورود به حساب خود استفاده خواهید کرد.",
  pinScreenEnterTitle: "رمز عبور خود را وارد کنید",
  pinScreenEnterSubtitle: "رمز عبور حساب کاربری {phoneNumber} را وارد کنید.",
  changeNumber: "تغییر شماره",
  confirmPinButton: "تایید و ادامه",
  invalidPinError: "رمز عبور باید حداقل ۶ کاراکتر باشد.",
  incorrectPinError: "رمز یا شماره تلفن وارد شده اشتباه است.",
  ...
  driverOnTheWay: "راننده در مسیر است",
  driverArrivedAtPickup: "راننده رسید",
  tripHasStarted: "سفر شما آغاز شد",
  ...
  chatButtonLabel: "چت",
  navigateToPickupButtonLabel: "مسیریابی",
  arrivedAtPickupButtonLabel: "به مبدأ رسیدم",
...
const psTranslations: TranslationSet = {
  ...
  pinScreenCreateTitle: "پټنوم جوړ کړئ",
  pinScreenCreateSubtitle: "تاسو به دا د خپل حساب ته د ننوتلو لپاره وکاروئ.",
  pinScreenEnterTitle: "خپل پټنوم دننه کړئ",
  pinScreenEnterSubtitle: "د {phoneNumber} حساب لپاره پټنوم دننه کړئ.",
  changeNumber: "شمیره بدله کړئ",
  confirmPinButton: "تایید او ادامه ورکړئ",
  invalidPinError: "پټنوم باید لږترلږه ۶ حروف ولري.",
  incorrectPinError: "ورکړل شوی پټنوم یا د تلیفون شمیره ناسمه ده.",
  ...
  driverOnTheWay: "چلوونکی په لاره دی",
  driverArrivedAtPickup: "چلوونکی ورسید",
  tripHasStarted: "ستاسو سفر پیل شو",
  ...
  chatButtonLabel: "چټ",
  navigateToPickupButtonLabel: "مسیریابی",
  arrivedAtPickupButtonLabel: "مبدأ ته ورسېدم",
...
const enTranslations: TranslationSet = {
  ...
  pinScreenCreateTitle: "Create a password",
  pinScreenCreateSubtitle: "You'll use this to log in to your account.",
  pinScreenEnterTitle: "Enter your password",
  pinScreenEnterSubtitle: "Enter the password for the account {phoneNumber}.",
  changeNumber: "Change number",
  confirmPinButton: "Confirm and Continue",
  invalidPinError: "Password must be at least 6 characters.",
  incorrectPinError: "Incorrect password or phone number.",
  ...
  driverArrivedAtPickup: "Driver has arrived",
  tripHasStarted: "Your trip has started",
  ...
  navigateToPickupButtonLabel: "Navigate",
  arrivedAtPickupButtonLabel: "Arrived at Pickup",
