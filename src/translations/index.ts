...
export const translations = {
  fa: {
    ...
    fetchingServicesError: "خطا در دریافت لیست سرویس‌ها.",
    ...
    // New keys for CurrentTripDetailsPanel
  ...
  ps: {
    ...
    fetchingServicesError: "د خدمتونو لیست په ترلاسه کولو کې تېروتنه.",
  ...
  en: {
    ...
    fetchingServicesError: "Error fetching service list.",
