...
interface ServiceSelectionSheetProps { currentLang: Language; routeDistanceKm: number | null; isCalculatingDistance: boolean; distanceError: string | null; onRequestRide: (service: Service, estimatedPrice: number | null) => void; }
const ServiceSelectionSheet: React.FC<ServiceSelectionSheetProps> = ({ currentLang, routeDistanceKm, isCalculatingDistance, distanceError, onRequestRide }) => {
  const t = translations[currentLang]; const isRTL = currentLang !== 'en';
...
const MapScreen = ({ currentLang }: { currentLang: Language }) => {
  ...
  return (
    <div style={mapScreenContainerStyle}>
      ...
      {showServiceSheet && confirmedOrigin && confirmedDestination && ( <ServiceSelectionSheet currentLang={currentLang} routeDistanceKm={routeDistanceKm} isCalculatingDistance={isCalculatingDistance} distanceError={distanceError} onRequestRide={handleRequestRideFromSheet} /> )}
