  ...
  const handleRequestClick = () => {
    ...
    if (service) {
      ...
      if (service.pricePerKm && routeDistanceKm !== null) {
        estimatedPrice = service.pricePerKm * routeDistanceKm; // No rounding
      } else if (service.price) {
        estimatedPrice = service.price; // No rounding
      }
