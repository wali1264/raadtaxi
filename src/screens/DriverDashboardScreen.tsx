...
export const DriverDashboardScreen = ({ onLogout }: DriverDashboardScreenProps): JSX.Element => {
  ...
  const drawTripMarkers = (originCoords: L.LatLngTuple, destinationCoords: L.LatLngTuple | null) => {
    ...
    const originLeafletIcon = L.divIcon({ html: originIconHTML, className: 'trip-origin-marker', iconSize: [32, 45], iconAnchor: [16, 45] });
    ...
    if (destinationCoords) {
        ...
        const destLeafletIcon = L.divIcon({ html: destIconHTML, className: 'trip-destination-marker', iconSize: [32, 45], iconAnchor: [16, 45] });
